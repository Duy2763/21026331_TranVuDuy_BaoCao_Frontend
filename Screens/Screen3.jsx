...
export default function Screen3() {
    ...
    const {carts, addCart, deleteCart, updateQuantity, decrementQuantity, checkExist, resetQuantity} = useCart();
                            ...
                            (
                                <View  key={item.id} style={styles.productContainer}> 
                                    <View style={styles.productImageAndTitleRating}>
                                        <Image
                                            source={{ uri: `http://192.168.1.35:3000/assets/products/${item.url}` }}
